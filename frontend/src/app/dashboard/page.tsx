      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        >
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-white">
                Hello, <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">{userName}</span>.
            </h1>
            <p className="text-slate-400 text-lg max-w-2xl">
                Welcome back to <span className="text-white font-semibold">Cortex</span>. You have <span className="text-indigo-400">{notebooks.length} active notebooks</span> ready for analysis.
            </p>
        </motion.div>
